    ...
    <section className="w-full py-20" id="approach">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4 ">
        <Card
          ...
          description="We plan and strategize the project to ensure the best outcome."
        >
          <CanvasRevealEffect
            animationSpeed={5.1}
        ...
        description="We develop the project and keep you updated on the progress.">
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        description="We develop the project and launch it for the world to see.">
          <CanvasRevealEffect
            animationSpeed={3}
...
const AceternityIcon = ({ order }: { order: string }) => {
  return (
    <div>
      <button className="relative inline-flex h-12 overflow-hidden rounded-full p-[1px] focus:outline-hidden focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50">
