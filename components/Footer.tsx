  ...
  return (
    <footer className='w-full mb-10 pb-10' id ="contact">
      ...
      <div className='flex flex-col md:flex-row items-center mt-16 justify-between'>
        <p className='md:text-base text-sm md:font-normal font-light'>Copyright © 2026 Think Zone LLC</p>

        <div className='flex items-center md:gap-3 gap-6'>
            {
              socialMedia.map((profile) => (
                <div className='w-10 h-10 cursor-pointer flex justify-center items-center backdrop-filter backdrop-blur-lg saturate-180 bg-black-200 rounded-lg border border-black-300' key={profile.id}>
